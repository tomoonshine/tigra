...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="mail_verification">
		<p>
			...
			<a href="http://{domain}" style="text-decoration: none; color: #24c299; font-weight: normal;"><xsl:value-of select="domain" /></a>.
		</p>
		<p>
		...
		<p>
			...
			<a href="{restore_link}" style="text-decoration: none; color: #24c299; font-weight: normal;"><xsl:value-of select="restore_link" /></a>
		</p>
	</xsl:template>
	...
	<xsl:template match="mail_password">
		<p>
			<xsl:text>Здравствуйте! Ваш новый пароль от сайта </xsl:text> 
			<a href="http://{domain}" style="text-decoration: none; color: #24c299; font-weight: normal;"><xsl:value-of select="domain" /></a>.
		</p>
		<p>
