...
<xsl:stylesheet	version="1.0"
					...
					<div class="row">
						<div class="span3">
							...
							<xsl:apply-templates select="document('usel://getObject/?name_property=new_product&amp;limit=3')/udata" mode="widget-category">
                                ...
                                <xsl:with-param name='class-widget' select="'widget LatestProducts'" />
							...
							<xsl:apply-templates select="document('udata://catalog/getObjectDiscount/3/')/udata" mode="widget-category">
                                ...
                                <xsl:with-param name='class-widget' select="'widget Productsonsale'" />
    ...
    <xsl:template match="property[value]" mode="widget-category">
        <xsl:param name='class-widget' select="'widget Text'" />
    ...
    <xsl:template match="property[value]" mode="widget-category-img1">
    	<div class="span4">
	    	<a href="{$settings//property[@name = 'link_to_img_1']/value}">
	    		<img src="{value}" class="super_img" />
			</a>  
		</div>  
    </xsl:template>
    ...
    <xsl:template match="property[value]" mode="widget-category-img2">
    	<div class="span4">
	    	<a href="{$settings//property[@name = 'link_to_img_2']/value}">
	    		<img src="{value}" class="super_img" />
			</a>  
		</div>  
    </xsl:template>
    ...
    <xsl:template match="property[value]" mode="widget-category-img3">
    	<div class="span4">
	    	<a href="{$settings//property[@name = 'link_to_img_3']/value}">
	    		<img src="{value}" class="super_img" />
			</a>  
		</div>  
    </xsl:template>
