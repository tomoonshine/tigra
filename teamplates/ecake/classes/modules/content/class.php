...
class content_custom extends def_module {
    ...
    public function includeQuickEditJs() {
		...
		$res = $ini_system->includeQuickEditJs();

		$res = str_replace('<script type="text/javascript" charset="utf-8" src="/js/jquery/jquery.js?'.$build.'"></script>', '<script type="text/javascript" charset="utf-8" src="/templates/ecake/js/jquery1.8.js"></script>', $res);
		$res = str_replace('<script type="text/javascript" charset="utf-8" src="/js/jquery/fancybox/jquery.fancybox.js?'.$build.'"></script>', "", $res);
		$res = str_replace('<script type="text/javascript" charset="utf-8" src="/js/cms/init_fancybox.js?'.$build.'"></script>', "", $res);
		$res = str_replace('<link type="text/css" rel="stylesheet" href="/js/jquery/fancybox/jquery.fancybox.css?'.$build.'" />', "", $res);
